<aside class="fixed left-0 top-0 hidden h-screen w-64 z-50 bg-zinc-50 dark:bg-zinc-950 md:flex flex-col py-8 shadow-sm">
    ...
    <nav class="flex-1 space-y-1">
        ...
        <a class="group flex items-center px-8 py-3 {{ request()->routeIs('audit-log') ? 'border-l-[3px] border-blue-600 bg-zinc-200/50 dark:bg-zinc-800/40 text-blue-700 dark:text-blue-300 font-bold transition-all' : 'text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors' }}"
